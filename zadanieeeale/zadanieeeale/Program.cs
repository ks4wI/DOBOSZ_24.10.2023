using zadanieeeale;
using System.Data;
//tworzenie list produktow i magazynow
List<Produkt> produkty = new List<Produkt>();
List<Magazyn> magazyny = new List<Magazyn>();

//Wstepne dane zeby funkcje zwracaly jakikolwiek wynik
...
//dzieki temu while menu nie jest 'jednorazowe'
while (true)
{
    ...
    switch (wybor)
    {
        //case odpowiedzialny za magazyny
        case "1":
        ...
        //case odpowiedzialny za produkty
        case "2":
            ...
            break;
        //case odpowiedzialny za produkty w magazynach
        case "3":
            ...
            break;
        //case odpowiedzialny za zamkniecie programu
        case "4":
            Console.WriteLine("Program zostanie zamkniety"); Environment.Exit(0);
            break;
        //gdy uzytkownik wpisze cos innego niz 1, 2, 3 lub 4 program wyswietla default
        default:
            Console.WriteLine("nieprawidlowy wybor");
            break;
